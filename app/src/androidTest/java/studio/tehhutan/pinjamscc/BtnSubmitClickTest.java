...
public class BtnSubmitClickTest{
    ...
    public void btnSubmitClickTest(){
        ...
        onView(withId(R.id.et_namapeminjam)).perform(typeText("Hasan Khadiki"), closeSoftKeyboard());
        onView(withId(R.id.et_organisasi)).perform(typeText("LDJ KISI"), closeSoftKeyboard());
        onView(withId(R.id.et_deskripsikegiatan)).perform(typeText("Upgrading Staff"), closeSoftKeyboard());
        int hour1 = 10;
        int minutes1 = 59;
        int hour2 = 11;
